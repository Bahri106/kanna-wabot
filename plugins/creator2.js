...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  await conn.sendMessage(m.chat, {
    contacts: [{
    "displayName": "ᴏᴡɴᴇʀ saifulʙᴏᴛ",
      "vcard": "BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:ᴏᴡɴᴇʀ saifulʙᴏᴛ\nitem1.TEL;waid=6285853570297:6285853570297\nitem1.X-ABLabel:📍 Creator\nitem2.EMAIL;type=INTERNET:bahri106@gmail.com\nitem2.X-ABLabel:💌 Email\nitem3.URL:https://bahri106/\nitem3.X-ABLabel:📮 Rest Api\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:ac\nitem4.X-ABLabel:🌍 Region | Otaku 🇯🇵\nitem5.X-ABLabel:───────[ SAIFUL-𝗕𝗢𝗧 ]───────\nEND:VCARD"
  }, {
